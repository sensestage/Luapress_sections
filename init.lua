...
-- 		-- subdir
-- 		subdir = dir,
-- 		-- sections/subdir/img0001.jpg
-- 		source = dir2 .. '/' .. f,
-- 		-- build/sections/subdir/images/img0001.jpg
-- 		dest = config.build_dir .. '/' .. dir2 .. '/images/' .. f,
-- 		-- build/sections/subdir/thumbs/img0001.jpg
-- -- 		thumb = config.build_dir .. '/' .. dir2 .. '/thumbs/' .. f,
-- 		-- img0001.html
-- 		htmlbase = base .. '.html',
-- 		-- build/sections/subdir/img0001.html
...
-- 	local f = assert(io.open(arg.plugin_path .. '/section_post.lhtml'))
...
-- 	    url = config.url,
-- 	    title = page.title .. " - Section " .. i .. "/" .. #images,
-- 	}
...
-- 
--     -- copy style.css
--     _file_copy(arg.plugin_path .. '/sectionstyle.css',
-- 	config.build_dir .. '/inc/sectionstyle.css')
-- 
--     -- build index (HTML code that replaces the plugin call)
--     local tbl = {}
--     for i, img in ipairs(images) do
-- 	tbl[#tbl + 1] = string.format("<a href=\"%s\"><img src=\"%s\"></a>\n",
-- 	    config.url .. "/sections/" .. img.subdir .. "/" .. img.htmlbase,
-- -- 	    config.url .. "/sections/" .. img.subdir .. "/thumbs/" .. img.imgname)
--     end

    -- protect from markdown
--     return "<div>" .. table.concat(tbl) .. "</div>"
    return "<div>" .. "hello section test" .. "</div>"
end
